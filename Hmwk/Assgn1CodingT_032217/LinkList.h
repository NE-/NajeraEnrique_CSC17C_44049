 ...
 * Date: 22 March 2017
 * Purpose: Rewrite Assignment 1 to use template class
 */
...
// Start template class LinkList
template <class T>
class LinkList{
    public:
        // Constructor
        LinkList(int howMany){
            // Input data
...
};// End template class LinkList

template <class T>
Link<T> *LinkList<T>::fillLst(T n){
...
template <class T>
void LinkList<T>::prntList(int perLine){
...
template <class T>
Link<T>* LinkList<T>::endLst(Link<T>* front){
...
template <class T>
void LinkList<T>::addBefore(T before, T val){
...
template <class T>
void LinkList<T>::addAfter(T after, T val){
    Link<T> *next = lnkList;       // Keep track of next node
    Link<T> *prev = new Link<T>;    // Store previous nodes to prevent overwrite
    Link<T> *newNode = new Link<T>; // Creates new node for new value
...
template <class T>
void LinkList<T>::delByValue(T val){
    /*
